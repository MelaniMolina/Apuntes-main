...
export const Forgot = () => {
  ...
  return (
    <>
      <div className="bg-white flex justify-center items-center w-1/2">
        <div className="md:w-4/5 sm:w-full">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-3">
              <button className="bg-blue-500 text-slate-300 border py-2 w-full rounded-xl mt-5 hover:scale-105 duration-300 hover:bg-gray-900 hover:text-white">
                Send email
              </button>
            </div>
          </form>
          ...
          <div className="mt-3 text-sm flex justify-between items-center">
            ...
            <Link
              to="/login"
              className="py-2 px-5 bg-blue-500 text-slate-300 border rounded-xl hover:scale-110 duration-300 hover:bg-gray-900 hover:text-white"
            >
              Login
            </Link>
          </div>
      ...
      <div
        className="w-1/2 h-screen bg-[url('/public/images/forgot-Log.jpg')] 
        bg-no-repeat bg-cover bg-center sm:block hidden  rounded-full 
        "
      ></div>
    </>
  );
